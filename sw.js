const CACHE='sobre-ruedas-v160';
const CORE=['./','./index.html','./manifest.webmanifest','./icon.svg','./brand-logo.jpg','./icon-96.png','./icon-180.png','./icon-192.png','./icon-512.png','./icon-1024.png'];
