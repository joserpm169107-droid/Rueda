const CACHE='sobre-ruedas-v164';
const CORE=['./','./index.html','./manifest.webmanifest','./icon.svg','./brand-logo.jpg','./logo-completo.jpg','./logo-login.jpg','./icon-96.png','./icon-180.png','./icon-192.png','./icon-512.png','./icon-1024.png'];
